...
from utils.styling import apply_style, page_header, footer, GREEN, PANEL, TEXT, TEXT_MUTED
...
st.set_page_config(page_title="Management Dashboard | Assemble", page_icon="📊", layout="wide")
apply_style(active="dashboard")
