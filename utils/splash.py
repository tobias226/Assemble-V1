...
def render_splash():
    st.markdown(
        ...
        .splash-title {{
            ...
            letter-spacing: -2px;
            margin: 0;
            background: linear-gradient(180deg, #FFFFFF 0%, #B9F3CE 100%);
        ...
        <div class="splash-wrap">
            ...
            <div class="splash-content">
                ...
                <p class="splash-subtitle">
                    A platform to strengthen employee voice and improve outcomes —
                    connecting people, culture and leadership in one place.
                </p>
            </div>
        </div>
        """,
    ...
    st.markdown('<p class="splash-hint" style="text-align:center;">Simulated prototype · No real employee data is used</p>',
                unsafe_allow_html=True)
